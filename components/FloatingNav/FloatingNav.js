    ...
    return (
        ...
        <div className={styles.container}>
            <ul id="nav_ul">
                ...
                <li onClick={() => scroll(sectionRefs[3])}><a id="4" ref={(el) => navRef[3] = el} data-tip="Design" data-class='nav_tip' data-place='right' data-offset='{"right":6}'><HiOutlinePencil /></a></li>
                <li onClick={() => scroll(sectionRefs[4])}><a id="5" ref={(el) => navRef[4] = el} data-tip="Projects" data-class='nav_tip' data-place='right' data-offset='{"right":6}'><FiLayers /></a></li>
                <li onClick={() => scroll(sectionRefs[5])}><a id="6" ref={(el) => navRef[5] = el} data-tip="Blogs" data-class='nav_tip' data-place='right' data-offset='{"right":6}'><FiFlag /></a></li>
                <li onClick={() => scroll(sectionRefs[6])}><a id="7" ref={(el) => navRef[6] = el} data-tip="Contact" data-class='nav_tip' data-place='right' data-offset='{"right":6}'><FiMessageCircle /></a></li>
            </ul>
