            ...
            <div className={styles.main} id='nav_con'>
                <div className={styles.container}>
                    ...
                    <div className={styles.links} id='links'>
                        <Link href="https://www.linkedin.com/in/aliya-manzoor">
                            <a target="_blank" className='p-link'><RiLinkedinLine /></a>
                        </Link>
                        {/* <Link href="/projects"> */}
                        <Link href="mailto:mzaliya25@gmail.com">
            ...
            <div className={styles.dropNav_con} id="dropNav_con">
                <div className={styles.dropNav}>
                    <ul>
                        ...
                        <li onClick={() => navToggle(sectionRefs[3])}><a id="4" ref={(el) => mobNavRef[3] = el} ><HiOutlinePencil />Design</a></li>
                        <li onClick={() => navToggle(sectionRefs[4])}><a id="5" ref={(el) => mobNavRef[4] = el} ><FiLayers />Projects</a></li>
                        <li onClick={() => navToggle(sectionRefs[5])}><a id="6" ref={(el) => mobNavRef[5] = el} ><FiFlag />Blogs</a></li>
                        <li onClick={() => navToggle(sectionRefs[6])}><a id="7" ref={(el) => mobNavRef[6] = el} ><FiMessageCircle />Contact</a></li>
                    </ul>
                    <div className={styles.mb_links}>
                        ...
                        <Link href="mailto:mzaliya25@gmail.com">
                            <a target="_blank" className='mb-link'><HiOutlineMail /></a>
                        </Link>
                    </div>
                </div>
            </div>
