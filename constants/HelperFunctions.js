...
export const sectionRefs = new Array(7)
export const navRef = new Array(7)
export const mobNavRef = new Array(7)
...
export const SkillData = {
    ...
    3: {
        ...
        info: 'Powerful modern frontend framework for building single page application',
        stars: "4",
        ex: "1 year of layout design and prototyping",
    },
    4: {
        icon: SiHtml5,
        name: 'HTML 5',
        info: 'Powerful modern frontend framework for building single page application',
        stars: "4.5",
        ex: "1 year of structuring web pages",
    },
    5: {
        icon: SiCss3,
        name: 'CSS 3',
        info: 'Powerful modern frontend framework for building single page application',
        stars: "4.5",
        ex: "1 year of styling and designing",
    },
    6: {
        ...
        info: 'Powerful modern frontend framework for building single page application',
        stars: "3",
        ex: "1 year of graphic designing",
    },
    7: {
        icon: SiNextDotJs,
        name: 'Next.js',
...
export const featuredBlogs = [
    {
        ...
        des: "A comprehensive guide to starting your journey in web development, covering HTML, CSS, and Javascript basics for beginners.",
        img: blog2,
    ...
    },
    {
        ...
        des: "Explore the latest features in React, including Hooks, Suspense, and Concurrent Mode to build highly performant user interfaces.",
        img: blog1,
    ...
    },
    {
        ...
        time: "8 minutes read",
        des: "Understand the core principles of good UI/UX design, including typography, color theory, and layout hierarchy for better user engagement.",
        img: blog3,
...
const topToBottomNavTarget = ['#ab_con', '#section3', '#section4', '#graphic-design', '#section5', '#section6', '#section7']
